# Grayscale Image Format Converter
`imgCvtGrayIntToDouble` is a subroutine that converts an **8-bit integer** input image into a **double floating point representation**.
...
<img width="483" height="316" alt="image" src="https://github.com/user-attachments/assets/e7129102-a1d6-4b98-b01f-2af11629cd07" />
